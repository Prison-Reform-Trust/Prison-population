...
##Reading in data
df = pd.read_csv("Data/female_population.csv",
...
fig.update_layout(title="<b>Female prison population in England and Wales</b>",
...
'''
This section outputs the final chart
'''

##Plot static image
fig.write_image("images/director_report/female_prison_population.png", width=655, height=500, scale=2)
