...
fig.update_layout(title="<b>Prison population in England and Wales</b>",
                  yaxis_title='People in prison',
                  yaxis_tickformat=',.0f',
...
##Plot static image
fig.write_image("images/director_report/prison_population.png", width=655, height=500, scale=2)
